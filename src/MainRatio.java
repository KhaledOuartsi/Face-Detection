 ...
 * @author Khaled
 */
public class MainRatio extends javax.swing.JFrame {
...
//    				BufferedImage ImageOriginal = (BufferedImage) image1;
    			...
    			BufferedImage	imagereduiteT=imagereduite;
        			...
        			if (imagereduiteT !=null){
        				...
        				BufferedImage peau=   d.DetecteV(imagereduiteT);
        				...
        				BufferedImage Dilataion = E.erosion(Erosion);
        				 int W = imagereduiteT.getWidth();
        			    	int H = imagereduiteT.getHeight();
        			    	r R = new r();
    			...
    			BufferedImage	imagereduite=resizeImage(ImageOriginal);
        			...
        			if (imagereduite !=null){
        				if (récupérerRGB(imagereduite)) {
        					...
        					BufferedImage peau=   d.DetecteV(imagereduite);
        					Dilatation S= new Dilatation();
        					BufferedImage Erosion =  S.dilatation(peau);
        					Erosion E=  new Erosion();
        					BufferedImage Dilataion = E.erosion(Erosion);
...
//		 seuille du visage aprés pour avoir les yeux
        			...
        			CCLabeling Cc= new CCLabeling(R.Pixel(iiDilate1), W, H);
        			int [][] oo=Cc.compute();
        			...
        			// ----------------------------------------------------------------------------
         			...
         			BufferedImage iiEro2 = erosio.erosion(ii2);
         			BufferedImage iiDilate2 = dilate.dilatation(iiEro2);
         			// labeling le seuille de l image 
         			CCLabeling Cc2= new CCLabeling(R.Pixel(iiDilate2), W, H);
         			int [][] oo2=Cc2.compute();
         			// construire une image avec les 2 cercle de yeux
...
//			    		g.drawRect(t[4], t[6], t[5], t[7]);
	...
	private void RationRadiobuttonActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	if ((Detection!=null)) {
			...
			if ((DetectionEyemap!=null)) {
			DetectionEyemap.stop();
		}
...
//		    		g.drawRect(t[4], t[6], t[5], t[7]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainRatio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
